...
#ifdef DVFS
float copy2D::time_table[FREQLEVELS][XITAO_MAXTHREADS][XITAO_MAXTHREADS];
float jacobi2D::time_table[FREQLEVELS][XITAO_MAXTHREADS][XITAO_MAXTHREADS];
#else
...
int main( int argc, char *argv[] )
{
   ...
   if(getenv("GOTAO_THREAD_BASE"))
    ...
    int schedulerid = 3;
    gotao_init_hw(-1,-1,-1);
    gotao_init(schedulerid, 16, 0, 0); // Parallelism = 16 = exdecomp * eydecomp
