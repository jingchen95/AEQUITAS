...
namespace xitao {   
  ...
  // extern std::list<PolyTask *> critical_ready_q[GOTAO_NTHREADS];
  // extern std::list<PolyTask *> ncritical_ready_q[GOTAO_NTHREADS];
  ...
  // extern int* required_freq;
  // extern int* current_freq;
  // extern int* active_state;
//  extern std::vector<int> queue_size;
};
#endif
